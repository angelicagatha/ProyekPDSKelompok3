...
<html>
    ...
    <body>
        ...
        <div class="container" style="text-align: center; margin-top: 3%; padding: 7%">
            <img src="../img/berhasil.png" style="height: 20%; width: 20%">
            <h3 style="margin-top: 1%;">Peminjaman Berhasil<br>Silahkan mengunjungi perpustakaan <i>offline</i></h3>
            <a href="homeuser.php"><u><h6>Back to Home</h6><u></a>
        </div>
    </body>
</html>